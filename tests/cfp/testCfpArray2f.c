...
int main()
{
  const struct CMUnitTest tests[] = {
    ...
    cmocka_unit_test(given_cfp_array2f_when_minimalCtor_expect_returnsNonNullPtr),
    ...
    cmocka_unit_test_setup_teardown(given_cfp_array2f_when_setEntry_expect_entryWrittenToCacheOnly, setupCfpArrSmall, teardownCfpArr),
    cmocka_unit_test_setup_teardown(given_cfp_array2f_when_getEntry_expect_entryReturned, setupCfpArrSmall, teardownCfpArr),
    cmocka_unit_test_setup_teardown(given_cfp_array2f_when_setIJ_expect_entryWrittenToCacheOnly, setupCfpArrSmall, teardownCfpArr),
    cmocka_unit_test_setup_teardown(given_cfp_array2f_when_getIJ_expect_entryReturned, setupCfpArrSmall, teardownCfpArr),
